...
% type  ml/good_coer_ty          ml/coer_ty -> o.
% type  ml/less_val_ty           ml/val_ty -> ml/val_ty -> o.
% type  ml/less_comp_ty          ml/comp_ty -> ml/comp_ty -> o.
...
% type  ml/dirt_coer             dirt -> ml/coer.
% type  ml/dirt_coer             dirt -> ml/coer.
% type  ml/empty_coer            dirt -> ml/coer.
% type  ml/cons_coer             op -> ml/coer -> ml/coer.
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% terms
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
