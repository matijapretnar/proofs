...
from_impure/val (d\exp/hand_ty (exp/bang (A d) d) (exp/bang (B d) _) empty (ml/hand2fun_coer Y1 Y2) :-
  to_impure/val A empty Y1,
  pi d' \ e2m/full_dirt d' => from_impure/comp (d\ exp/bang (B d) d') empty Y2.
